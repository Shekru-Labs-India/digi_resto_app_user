                ...
                <div className="single-widget">
                  ...
                  <ul className="address">
                    ...
                    <li>
                      ...
                      <a href="mailto:info@menumitra.com">info@menumitra.com</a>
                    </li>
                    <li>
                ...
                <div className="col-6 mb-3">
                  <div className="single-widget">
                    ...
                    <ul className="links">
                      ...
                      <li>
                        <Link to="/user_app/Index">User App</Link>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="col-6 mb-3">
                  <div className="single-widget">
                    ...
                    <ul className="links">
                      ...
                      <li>
                        <a href="index.html#">Help and support</a>
                      </li>
                      <li>
