...
const [selectedCategory, setSelectedCategory] = useState(null);
    ...
    const fetchMenuData = async () => {
      try {
        ...
        if (data.st === 1) {
          ...
          setIsFavorite(data.is_favourite === 1);
  ...
  <div><i
    ...
    style={{ marginLeft: '110px', marginTop:'-70px', cursor: 'pointer' }}
...
//   const handleImageClick = async (menuId) => {
//     try {
//       const response = await fetch(
//         "http://194.195.116.199/user_api/get_menu_details",
//         {
//           method: "POST",
//           headers: {
//             "Content-Type": "application/json",
...
//         // Pass the menuItem object to the MenuDetails route
//         navigate(`/ProductDetails/${menuId}`, { state: { menuItem: menuData } });
//       } else {
...
//                         e.target.src = images;
//                       }}
//                       onClick={() => handleImageClick(menuItem.menu_id)}
//                     />
//                      {/* </Link> */}
//                   </div>
