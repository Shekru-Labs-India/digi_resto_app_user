            ...
            <div className="card-body p-2">
              ...
              <div className="row mt-2 align-items-center">
                <div className="col-4 pe-1">
                  <p className="mb-0 customFontSizeBold text-break ">
                ...
                <div className="col-3 px-0 text-center">
                  <p className="mb-0 customFontSizeBold  gray-text ">
              ...
              <div className="row">
                <div className="col-12">
                  <div className="d-flex justify-content-between align-items-center fw-medium mb-2">
                    ...
                    <h5 className="ps-2 customFontSizeBold fw-medium">Grand Total</h5>
